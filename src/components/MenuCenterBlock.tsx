...
export default function MenuCenterBlock() {
    ...
    return (
        <div className="flex-1 bg-gradient-to-b from-[#FFD695] to-[#E84596] rounded-[32px] p-6 md:p-10 flex flex-col items-center overflow-hidden w-full relative group shadow-inner">
            ...
            <div className="flex-1 w-full flex flex-col gap-6 overflow-y-auto overflow-x-hidden no-scrollbar pb-10 z-10 px-2 min-h-[400px]">
