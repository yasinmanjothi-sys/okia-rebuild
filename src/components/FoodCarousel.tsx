...
export default function FoodCarousel() {
    ...
    return (
        <div className="flex-[2] bg-[#FFD695] rounded-[32px] p-6 lg:p-4 relative overflow-hidden flex flex-col items-center group">
            <h2 className="font-okia text-4xl md:text-5xl lg:text-4xl text-[#6E0D31] lg:text-white tracking-widest mb-6 z-10 drop-shadow-sm uppercase text-center">Signature Food</h2>
